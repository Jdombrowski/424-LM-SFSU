...
\newcommand{\hmwkDueDate}{Thrusday,\ November\ 2,\ 2017} % Due date
...
------------------------------------------------------------------------------------
\end{lstlisting}
The algorithm yields that V2 and V4 (x1 and x3) are the components in the final model. Wich is the same result we come to in the manual calculation. 
